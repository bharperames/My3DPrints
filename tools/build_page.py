...
FAMILIES = [
 ...
 dict(slug="hourglass_cone", material=("PLA", "PLA — the set\u2019s 35\u201339\u00b0 top flares are measured curl territory where PETG fails; designer printed PETG, geometry says PLA"), name="Impossible Hourglass — Cone", designer="Idea2Item · Printables · CC BY-NC-SA",
 ...
 dict(slug="hourglass_pyramid", material=("PLA", "PLA — the set\u2019s 35\u201339\u00b0 top flares are measured curl territory where PETG fails; designer printed PETG, geometry says PLA"), name="Impossible Hourglass — Pyramid", designer="Idea2Item · Printables · CC BY-NC-SA",
 ...
 dict(slug="magic_spinning_top_23_de_fight_d", material=("PLA", "PLA — use the “PLA” connector for silk/slippery filaments; PETG tip survives drops better"), name="Magic Spinning Top", designer="AeroDesigns · “floating” illusion",
      ...
      principle="A floating-ring illusion top: upper and lower halves are each genus-3 solids — an outer ring joined to the hub by 3 spokes — so the spinning ring appears detached from the center spike. Mass at the rim gives the long spin.",
 ...
 dict(slug="quantum_skull", material=("PLA", "PLA — harder, slicker faces glide better for the sliding fidget"), name="Quantum Skull", designer="Gmino · original",
      ...
      drivers=["half size 81 × 103 × 37 mm", "print each half in a different color (two plates)", "mating clearance between the shells"],
 ...
 dict(slug="pikachu_more_resistant_one_color", material=("PETG", "PETG — keychain abuse bends thin links; brittle PLA is the failure the v2 rework addressed"), name="Pikachu Flexy Keychain", designer="B-Forge3D · v2 “more resistant”",
      ...
      principle="A print-in-place articulated flexy: one object containing 7 interlocked bodies (head, tail and body segments) that hinge without assembly. This file is itself the fix — the reinforced single-color v2 replacing the fragile multi-color original.",
 ...
 dict(slug="oneoff_stls", material=("PLA", "PLA — experiment prints; the Voronoi shell needs ≥20× scale and clean thin walls"), name="One-off Experiments", designer="(local exports, unattributed)",
      ...
      drivers=["arch: lobe count and arch sweep", "remesh: averaging threshold 0.900 sets smoothness", "voro sphere: cell count = genus 56, shell thickness", "voro sphere modeled at unit scale — Ø2 mm as saved"],
...
FIXES = [
 ...
 ("Pikachu", "Entire file is the replacement: v2 “more resistant” rebuild of a fragile original, in single-color form."),
...
ALLFILES = [
 ...
 ("pufferfish-p2s-onecolor.3mf", "5.63", "Pufferfish", "warn", "same geometry, one color"),

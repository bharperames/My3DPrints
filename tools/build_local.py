...
add("held_chain", "held-sphere-chained.3mf", "held_chained", "Designed here", "Claude · this session", "PLA",
    "Held Sphere + Chain", "Chainmail onto the lattice: the cage gets one attachment window (3 of 120 struts removed, merging four openings into one ≈Ø13) and the hook is simply a longer, wider chain link — 20×12 mm, Ø2.4 tube, standard 45° tilt — threaded through the window around its sill strut. Nothing welded, no extra hardware; capture proven by ray-escape test, 0.53 mm running clearance, chain joints ≥0.48 mm. Prints flat in one job.", ("pass", "Designed · ready"), mate="Held Sphere (chainless version)")
